...
local cases = {
  ...
  { "ssh://git@github.com/user/repo.git", "github.com", "user", "repo", "https://github.com/user/repo" },
  { "https://github.com/user/repo", "github.com", "user", "repo", "https://github.com/user/repo" },
  { "https://github.com/user/repo.git", "github.com", "user", "repo", "https://github.com/user/repo" },
}
...
do
  local url = browse.build_file_url("https://github.com/user/repo", "github.com", "path/to/file.txt", "main", 10, 20)
  runner.assert_test("GH url with range", url == "https://github.com/user/repo/blob/main/path/to/file.txt#L10-L20", url or "")
  local url2 = browse.build_file_url("https://github.com/user/repo", "github.com", "path/to/file.txt", "main", 5, 5)
  runner.assert_test("GH url single line", url2 == "https://github.com/user/repo/blob/main/path/to/file.txt#L5", url2 or "")
end
